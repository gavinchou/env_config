...
#===============================================================================
# The following is for pretty libcxx, depending on the installed libraries
# Some path or import function names should be modified accordingly
...
#python
#import sys
#sys.path.insert(0, '/mnt/disk1/gavinchou/opt/ldb-toolchain/share/gdb/libcxx/')
